      ...
      <section className="relative py-24 lg:py-32 overflow-hidden">
        ...
        <div className="absolute inset-0 opacity-5">
          <div
            ...
            style={{
              backgroundImage: `linear-gradient(${getComputedStyle(document.documentElement).getPropertyValue("--primary")} 1px, transparent 1px), linear-gradient(90deg, ${getComputedStyle(document.documentElement).getPropertyValue("--primary")} 1px, transparent 1px)`,
